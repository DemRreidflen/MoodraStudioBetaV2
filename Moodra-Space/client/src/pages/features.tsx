    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Role Models — upload EPUB, FB2, or TXT files and get a deep style analysis with full author cognitive reconstruction",
          ...
          "Click any role model card to view the full analysis — cognitive profile, style patterns, rhythm, vocabulary, and more",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Клик по карточке → полный профиль: когнитивный портрет, паттерны стиля, ритм, словарь и многое другое",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Клік по картці → повний профіль: когнітивний портрет, патерни стилю, ритм, словник тощо",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Klick auf eine Karte → vollständiges Profil: kognitives Porträt, Stilmuster, Rhythmus, Wortschatz und mehr",
