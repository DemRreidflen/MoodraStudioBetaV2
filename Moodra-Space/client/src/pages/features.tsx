    ...
    sections: [
      {
        ...
        items: [
          ...
          "12 block types: paragraphs, headings, quotes, hypotheses, arguments, research, dividers and more",
          "Rich formatting toolbar: bold, italic, underline, text colour, highlight, alignment, lists, indent",
          ...
          "Improve chapter with AI while preserving your voice and intent",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "12 типов блоков: абзацы, заголовки, цитаты, гипотезы, аргументы, исследования, разделители и другие",
          "Панель форматирования: жирный, курсив, подчёркивание, цвет текста, выделение, выравнивание, списки, отступ",
          ...
          "Улучшение главы с AI: голос и смысл сохраняются",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "12 типів блоків: абзаци, заголовки, цитати, гіпотези, аргументи, дослідження, розділювачі та інші",
          ...
          "Покращення розділу з AI: голос і зміст зберігаються",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "12 Blocktypen: Absätze, Überschriften, Zitate, Hypothesen, Argumente, Forschung, Trennzeichen u. v. m.",
          ...
          "Kapitelverbesserung mit KI bei Beibehaltung deiner Stimme",
          "Vergleich von Original und verbesserter Version vor der Annahme",
        ],
      },
      {
        icon: Brain,
