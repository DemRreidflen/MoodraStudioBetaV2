  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          "Drafts panel — full block editor with font scale, max-width, word count, and autosave",
          "Select any text in a draft → floating AI toolbar: Improve, Rewrite, Simplify, Expand, Translate, Fix grammar — identical to the main editor experience",
          "Apply AI result inline or insert as a new paragraph — via a clean before/after modal",
          "Typewriter mode — cursor stays vertically centred, keeping focus at eye level",
          "Sprint timer — set a word goal and time limit (5–60 min), start countdown, stop any time",
          "AI Co-Author panel inside the draft editor — toggle with one button",
          "Move any draft to your book as a new chapter or append to an existing one — one click",
          "Role Models — upload EPUB, FB2, or TXT and get a complete cognitive reconstruction of any author's style",
          "Dual-model parallel analysis: gpt-4o-mini scans surface patterns while gpt-4o performs deep cognitive reconstruction — results are merged into a single rich author fingerprint",
          "Custom instruction field: focus the analysis on structure, rhetoric, rhythm, or anything specific",
          "Role model functions require API key — clear prompt to connect when not yet configured",
          "\"Use in book\" — saves any analyzed author's style as your book's writing context",
        ],
      },
      {
        icon: Brain,
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Выделите любой текст → плавающая AI-панель: Улучшить, Переписать, Упростить, Расширить, Перевести, Исправить грамматику — как в основном редакторе",
          "Применить результат AI прямо или вставить новым абзацем — через модальное окно «до/после»",
          "Режим пишущей машинки — курсор всегда по центру экрана, фокус на уровне глаз",
          "Таймер спринта — цель по словам и лимит времени (5–60 мин), запустить обратный отсчёт, остановить в любой момент",
          ...
          "Ролевые модели — загрузите EPUB, FB2 или TXT и получите полную когнитивную реконструкцию авторского стиля",
          "Параллельный анализ двух моделей: gpt-4o-mini сканирует поверхностные паттерны, gpt-4o выполняет глубокую реконструкцию — результаты объединяются в единый профиль автора",
          "Поле особых указаний: задайте AI фокус анализа — структура, риторика, ритм или что угодно",
          "Функции ролевых моделей требуют API-ключа — чёткий запрос на подключение, если ключ ещё не добавлен",
          "«Использовать в книге» — сохраняет стиль проанализированного автора как контекст вашей книги",
        ],
      },
      {
        icon: Brain,
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Виділіть будь-який текст → плаваюча AI-панель: Покращити, Переписати, Спростити, Розширити, Перекласти, Виправити граматику — так само, як в основному редакторі",
          "Застосувати результат AI або вставити новим абзацем — через вікно «до/після»",
          "Режим друкарської машинки — курсор завжди по центру екрана, фокус на рівні очей",
          "Таймер спринту — ціль по словах і ліміт часу (5–60 хв), запустити відлік, зупинити будь-коли",
          ...
          "Рольові моделі — завантажте EPUB, FB2 або TXT і отримайте повну когнітивну реконструкцію авторського стилю",
          "Паралельний аналіз двох моделей: gpt-4o-mini сканує поверхневі патерни, gpt-4o виконує глибоку реконструкцію — результати об'єднуються в єдиний профіль автора",
          "Поле особливих вказівок: задайте AI фокус аналізу — структура, риторика, ритм або будь-що інше",
          "Функції рольових моделей потребують API-ключа — чіткий запит на підключення, якщо ключ ще не додано",
          "«Використати в книзі» — зберігає стиль проаналізованого автора як контекст вашої книги",
        ],
      },
      {
        icon: Brain,
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Text markieren → schwebende KI-Toolbar: Verbessern, Umschreiben, Vereinfachen, Erweitern, Übersetzen, Grammatik — identisch mit dem Haupteditor",
          "KI-Ergebnis direkt übernehmen oder als neuen Absatz einfügen — über ein klares Vorher/Nachher-Modal",
          "Schreibmaschinen-Modus — Cursor bleibt immer vertikal zentriert, Fokus auf Augenhöhe",
          ...
          "Vorbilder — EPUB, FB2 oder TXT hochladen und vollständige kognitive Rekonstruktion des Autorenstils erhalten",
          "Parallele Analyse mit zwei Modellen: gpt-4o-mini scannt Oberflächenmuster, gpt-4o führt Tiefenrekonstruktion durch — Ergebnisse werden zu einem einzigen reichen Autorenprofil zusammengeführt",
          "Anweisungsfeld: lege den KI-Fokus der Analyse fest — Struktur, Rhetorik, Rhythmus oder beliebiges",
          "Vorbild-Funktionen erfordern API-Schlüssel — deutliche Aufforderung zur Verbindung wenn noch nicht konfiguriert",
          "'Im Buch verwenden' — speichert den Stil eines analysierten Vorbilds als Buchkontext",
        ],
      },
      {
        icon: Brain,
