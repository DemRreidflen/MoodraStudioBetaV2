...
const IDEA_BOARD_I18N: Record<string, Record<string, string>> = {
  en: {
    ...
    aiIdeas: "AI ideas", aiSuggestions: "AI suggestions", basedOnSelected: "Based on selected",
  ...
  ru: {
    ...
    aiIdeas: "AI идеи", aiSuggestions: "AI-предложения", basedOnSelected: "На основе выбранных",
  ...
  ua: {
    ...
    aiIdeas: "AI ідеї", aiSuggestions: "AI-пропозиції", basedOnSelected: "На основі вибраних",
  ...
  de: {
    ...
    aiIdeas: "KI-Ideen", aiSuggestions: "KI-Vorschläge", basedOnSelected: "Basierend auf Auswahl",
